...
<input type="text" min="**************" step="**************" class="form-control" path="card_number" id="card_number" name="card_number" placeholder="Enter Your Card Number" required /></div>
 </div>
